...
class F5TTSMelExtractor(FeatureExtractor):
    ...
    def __init__(self, config: Optional[F5TTSMelConfig] = None):
        ...
        self._resamplers: Dict[
            tuple[int, int, str], torchaudio.transforms.Resample
        ] = {}
    ...
    @property
    def feature_sampling_rate(self) -> int:
    ...
    def _get_resampler(
        ...
        device_str = str(device)
        key = (orig_freq, new_freq, device_str)
    ...
    def _trim_or_pad_features(
        ...
        expected_num_frames = compute_num_frames(
            ...
            sampling_rate=self.feature_sampling_rate,
        )
