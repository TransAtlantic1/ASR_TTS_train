...
```bash
cd /inspire/hdd/project/embodied-multimodality/chenxie-25019/fj/ASR_TTS_train/egs/zipformer_24k_multilang/zipformer_24k_zh/ASR
...
```bash
bash /inspire/hdd/project/embodied-multimodality/chenxie-25019/fj/ASR_TTS_train/test/recipes/emilia24k/prepare_minimal_real_data.sh
```
...
```bash
bash /inspire/hdd/project/embodied-multimodality/chenxie-25019/fj/ASR_TTS_train/test/recipes/emilia24k/run_smoke_train.sh \
  --mode smoke
```
...
- 最小真实数据验证脚本在 [test/recipes/emilia24k](/inspire/hdd/project/embodied-multimodality/chenxie-25019/fj/ASR_TTS_train/test/recipes/emilia24k)
- 可选 watcher 在 [asr_op/emilia/watcher](/inspire/hdd/project/embodied-multimodality/chenxie-25019/fj/ASR_TTS_train/asr_op/emilia/watcher)
