...
class EmiliaAsrDataModule:
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            help=(
                ...
                "<dataset>_<language>, e.g. emilia_zh or jellycat_zh."
            ),
        )
        group.add_argument(
            "--transcript-source",
        ...
        group.add_argument(
            ...
            default=None,
            help=(
                "Optional external validation CutSet manifest. When omitted, "
                "load the recipe-local dev cuts from the manifest dir."
            ),
        )
        group.add_argument(
            "--max-duration",
    ...
    def dev_cuts(self) -> CutSet:
        ...
        if dev_cuts_path not in (None, ""):
            return load_manifest_lazy(Path(dev_cuts_path))
