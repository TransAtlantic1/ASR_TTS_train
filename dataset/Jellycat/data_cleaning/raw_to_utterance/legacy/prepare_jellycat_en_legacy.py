...
def get_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        description="Cut Jellycat en-us podcast segments into utterance FLAC files.",
    )
    ...
    parser.add_argument(
        ...
        default=["en-us"],
        choices=["en-us"],
        help="Source language manifests to process and merge into EN.",
    )
    parser.add_argument(
        "--manifest-stem",
        default="jellycat_EN_segments",
...
def write_summary(
    *,
    ...
    summary = {
        ...
        "audio_format": "flac",
        "directory_layout": "EN/EN_P000000/EN_P000000_S00000/flac/EN_P000000_S00000_W00000000.flac",
