...
def get_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        description="Cut Jellycat zh/zh-cn podcast segments into utterance FLAC files.",
    )
    ...
    parser.add_argument(
        ...
        default=["zh", "zh-cn"],
        choices=["zh", "zh-cn"],
        help="Source language manifests to process and merge into ZH.",
    )
    parser.add_argument(
        "--manifest-stem",
        default="jellycat_ZH_segments",
...
def write_lhotse_items(
    ...
    recording_writer.write(recording)
    supervision_writer.write(supervision)
...
def write_summary(
    *,
    ...
    summary = {
        ...
        "audio_format": "flac",
        "directory_layout": "ZH/ZH_P000000/ZH_P000000_S00000/flac/ZH_P000000_S00000_W00000000.flac",
...
def main() -> None:
    ...
    with open_jsonl_writer(segment_manifest_path) as segment_writer, open_jsonl_writer(
        ...
        if args.skip_lhotse:
            ...
            with RecordingSet.open_writer(lhotse_recordings_path) as recording_writer, SupervisionSet.open_writer(
